...
@property (strong, nonatomic) IBOutlet UIButton *doneForDayButton;
@property (strong, nonatomic) IBOutlet UILabel *doneForDayLabel;
@property (strong, nonatomic) IBOutlet UIButton *partiallyFilledButton;
@property (strong, nonatomic) IBOutlet UILabel *partiallyFilledLabel;
@property (strong, nonatomic) IBOutlet UIButton *sellButton;
@property (strong, nonatomic) IBOutlet UILabel *sellLabel;
@property (strong, nonatomic) IBOutlet UILabel *canceledButton;
@property (strong, nonatomic) IBOutlet UILabel *canceledLabel;

@property (strong, nonatomic) IBOutlet UILabel *filledButton;
@property (strong, nonatomic) IBOutlet UILabel *filledLabel;
@property (strong, nonatomic) IBOutlet UILabel *hideFiltersLabel;
@property (strong, nonatomic) IBOutlet UIButton *hideFiltersButton;

- (IBAction)hideFiletrsButtonPressed:(id)sender;
