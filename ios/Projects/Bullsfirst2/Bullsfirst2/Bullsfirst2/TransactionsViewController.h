...
@interface TransactionsViewController : TabViewController<UITableViewDataSource,DatePickerViewControllerDelegate,AccountDropdownViewControllerDelegate, UIPickerViewDataSource, UIPickerViewDelegate>
{
...
@property (strong, nonatomic) IBOutlet UILabel *accName;

// data for populating picker view

@property (strong, nonatomic) NSArray *accountOptions;

// display picker view in an action sheet
@property (strong, nonatomic) IBOutlet UIPickerView *accNamePickerList;
