...
namespace Bullsfirst.Module.TransactionHistory.Views
{
    ...
    public partial class TransactionHistoryView : UserControl
    {
        ...
        {
            Debug.WriteLine("[Debug] TransactionHistoryView.TransactionHistoryView()");
            InitializeComponent();
        }

        [Import]
        public ITransactionHistoryViewModel ViewModel
        {
