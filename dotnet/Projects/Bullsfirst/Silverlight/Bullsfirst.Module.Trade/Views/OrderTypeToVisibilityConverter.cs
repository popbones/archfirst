...
{
    /// <summary>
    /// If OrderType = Limit, visibility=Visible, otherwise visibility=Collapsed
    /// </summary>
    public class OrderTypeToVisibilityConverter : IValueConverter
    {
        ...
        /// Converts OrderType to a Visibility
        /// </summary>
        public object Convert(
            object value, Type targetType, object parameter, CultureInfo culture)
        {
            return ((OrderType)value == OrderType.Limit) ? Visibility.Visible : Visibility.Collapsed;
        }

        /// <summary>
        /// Used to modify data as it is saved from the control to the source object.
        /// Converts Visibility to OrderType
