...
};AF.Grid.extension={};}(jQuery));(function(f){if(!f.browser){var n=/MSIE(.*?);/.exec(navigator.appVersion);f.browser={msie:navigator&&navigator.appName.indexOf("Microsoft")>-1,version:n&&n[1]};}if(f.browser.msie&&parseInt(f.browser.version,10)<=7&&document.documentMode!==8){f("html").addClass("ie7below");
