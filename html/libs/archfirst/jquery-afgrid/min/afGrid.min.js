...
}function q(){return B;}function x(){return a.extend({},e);}return a.extend({},AF.Grid.extension,{load:o,destroy:D,refresh:h,resetAndRefresh:c,getDefaultOptions:q,getCurrentOptions:x,getCurrentMetaData:v,getSource:s});};AF.Grid.extension={};}(jQuery));(function(f){if(!f.browser){f.browser={msie:navigator&&navigator.appName.indexOf("Microsoft")>-1,version:navigator.appVersion};
}if(f.browser.msie&&parseInt(f.browser.version.slice(0,1),10)<=7&&document.documentMode!==8){f("html").addClass("ie7below");}f.afGrid=f.extend(f.afGrid,{appendRows:"afGrid-append-rows",destroy:"afGrid-destroy",renderingComplete:"afGrid-rendering-complete",adjustRowWidth:"afGrid-adjust-row-width",showLoading:"afGrid-showLoading",hideLoading:"afGrid-hideLoading",getElementId:function(G){var F=G.split("_");
