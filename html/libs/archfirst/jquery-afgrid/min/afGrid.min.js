...
}P=e(O,J,Y,I,P,M);}});}S=P[G-1];}R=a(K,V,W,G,M);if((T+(F?1:0))%2===0){R.addClass("even");}if(T===0){R.addClass("row-first");}if(L){R.css("width",L);}S.append(R);});return{$groupContainers:P,currentGroupValues:I};}function a(J,I,Q,G,M){I=Q.id;var L=I?Q.data:Q,N=f(m.supplant({level:G,id:J+"DataRow_"+I})),O=M[G-1];
