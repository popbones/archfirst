...
/**
 * TransferCashBrokerageToExternalTest
 *
 * @author Naresh Bhatia
 */
public class TransferCashBrokerageToExternalTest extends BaseAccountsTest {
    
    public void setBrokerageAccountCashPosition(BigDecimal amount) throws Exception {
    ...
    public void transfer(BigDecimal amount) {
        this.baseAccountService.transferCash(
                new Money(amount), brokerageAccount1Id, externalAccount1Id);
    }
