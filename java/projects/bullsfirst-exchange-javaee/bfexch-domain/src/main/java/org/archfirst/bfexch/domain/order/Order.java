...
public class Order extends DomainEntity implements Comparable<Order> {
    ...
    @Type(
        ...
        parameters = {
            @Parameter (
                name  = "enumClass",
                value = "org.archfirst.bfexch.domain.order.OrderSide")
            }
        )
    ...
    @Type(
        ...
        parameters = {
            @Parameter (
                name  = "enumClass",
                value = "org.archfirst.bfexch.domain.order.OrderType")
            }
        )
    @Column(nullable = false, length=Constants.ENUM_COLUMN_LENGTH)
    ...
    @Type(
        ...
        parameters = {
            @Parameter (
                name  = "enumClass",
                value = "org.archfirst.bfexch.domain.order.OrderTerm")
            }
        )
    @Column(nullable = false, length=Constants.ENUM_COLUMN_LENGTH)
    ...
    @Type(
        ...
        parameters = {
            @Parameter (
                name  = "enumClass",
                value = "org.archfirst.bfexch.domain.order.OrderStatus")
            }
        )
    @Column(nullable = false, length=Constants.ENUM_COLUMN_LENGTH)
